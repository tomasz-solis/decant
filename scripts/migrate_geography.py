...
def migrate_geography():
    ...
    console.print("\n[bold]World Geography Migration[/bold]\n")
    ...
    if 'country' not in df.columns:
        df['country'] = 'Unknown'
        console.print("[dim]OK Added country column (default: 'Unknown')[/dim]")

    if 'region' not in df.columns:
        df['region'] = 'Unknown'
        console.print("[dim]OK Added region column (default: 'Unknown')[/dim]")
